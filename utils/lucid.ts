...
// import { contr1Seed } from "../pages/seed.tsx"
...
//     ].enable())
    ...
    const lucid = await Lucid.new(
        ...
        // ,'Preview');
    // const lucid = await Lucid.new(
    //         new Blockfrost("https://cardano-preview.blockfrost.io/api/v0", "previewxxxxx"),
    //         "Preview",
    //       );
    // const lucid = await Lucid.new(
    //         new Blockfrost('https://cardano-mainnet.blockfrost.io/api/v0', "mainnetxxxxxx") //process.env.NEXT_PUBLIC_BLOCKFROST as string),
    //         ,'Mainnet')
...
const fetchBlockFrostApi = async () => {
    try {
